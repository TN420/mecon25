...
if __name__ == "__main__":
    ...
    base_dir = "/home/w5/pydemo/mecon25/results/results_a2c_gamma_{}"
    csv_file_path = "/home/w5/pydemo/mecon25/averages_a2c_gammas.csv"
    ...
    print(f"Averages for all A2C gammas written to {csv_file_path}")
