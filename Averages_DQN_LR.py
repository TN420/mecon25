...
if __name__ == "__main__":
    ...
    base_dir = "/home/w5/pydemo/mecon25/results/results_dqn_lr_{}"
    csv_file_path = "/home/w5/pydemo/mecon25/averages_dqn_lrs.csv"
    ...
    print(f"Averages for all DQN learning rates written to {csv_file_path}")
