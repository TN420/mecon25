...
if __name__ == "__main__":
    ...
    base_dir = "/home/w5/pydemo/mecon25/results/results_rdqn_lr_{}"
    csv_file_path = "/home/w5/pydemo/mecon25/averages_rdqn_lrs.csv"
    ...
    print(f"Averages for all RDQN learning rates written to {csv_file_path}")
